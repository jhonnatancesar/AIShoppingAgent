...
As TASKs 000 a 047 e as TASKs 055 a 060 estão concluídas. A TASK-038 recomenda
...
único com ownership obrigatório (`DEC-034`). A próxima tarefa executável é a
TASK-061 (autenticação real por usuário e senha), antes da TASK-048
(`DEC-033`); ela não pertence mais à fila da V1.2.
