...
- `20260807_0002`: semeia as quatro lojas selecionáveis da V1 (`pichau`, `terabyte`, `amazon`, `kabum`), conforme `docs/architecture/providers.md`, necessárias para `MissionSource.store_id`. O downgrade remove exatamente essas quatro linhas por código, nunca um `DELETE` genérico.
