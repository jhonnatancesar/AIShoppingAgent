...
Este documento define integralmente a V1. Qualquer item que não esteja listado nesta página está fora do escopo da primeira versão e deve ser registrado em `docs/internal/backlog.md` quando for uma evolução desejável.
