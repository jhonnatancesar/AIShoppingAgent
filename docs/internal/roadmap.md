...
| Cotas e capacidade por usuário | TASK-107 | Backend e frontend implementados no DEV (commits locais `ac34725`/`faa939c`/`83a9572`, não publicados); `max_active_missions=5`, `max_store_slots=18`, `max_daily_searches=30`, nunca pausa/cancela automaticamente, UX obrigatória com ações contextuais, override por ADMIN (`DEC-094`) |
