...
| Cotas e capacidade por usuário | TASK-107 | Backend implementado no DEV (commit local `ac34725`, não publicado); `max_active_missions=5`, `max_store_slots=18`, `max_daily_searches=30`, nunca pausa/cancela automaticamente, override por ADMIN (`DEC-094`). UX obrigatória no frontend ainda pendente |
