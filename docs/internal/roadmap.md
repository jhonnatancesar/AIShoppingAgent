...
| Pesquisa de cupons | TASK-106 | Formalizada; fonte principal é o site oficial de cada loja (mesma arquitetura de Store Provider), sem Firecrawl nem agregador de terceiro nesta versão; somente com evidência real, IA nunca inventa código/desconto (`DEC-088`). Aguardando auditoria real por loja antes de código |
