...
As TASKs 000 a 014, a TASK-016, as TASKs 018 a 024 e a TASK-055 estão concluídas. A próxima tarefa executável é a TASK-025. A TASK-015 será executada após a TASK-026, pois depende de `collection_runs`; a TASK-017 permanece logo depois dela. As demais continuam pendentes e só podem ser iniciadas por solicitação explícita. A V1 pesquisa Pichau, Terabyte, Amazon e Kabum; Mercado Livre, Shopee e AliExpress permanecem futuras.
