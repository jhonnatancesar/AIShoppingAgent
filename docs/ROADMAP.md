...
As TASKs 000 a 014, a TASK-016 e as TASKs 018 a 021 estão concluídas. A próxima tarefa executável é a TASK-022. A TASK-015 será executada após a TASK-026, pois depende de `collection_runs`; a TASK-017 permanece logo depois dela. As demais continuam pendentes e só podem ser iniciadas por solicitação explícita. A V1 pesquisará Pichau, Terabyte, Amazon e Kabum; Mercado Livre, Shopee e AliExpress permanecem futuras.
