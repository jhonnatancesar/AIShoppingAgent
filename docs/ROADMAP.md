...
Somente a TASK-000 está concluída. As demais são planejamento e só podem ser iniciadas por solicitação explícita. A V1 permanece focada em lojas nacionais; Marketplace Module não pertence ao escopo da V1.
