...
intenção estruturada está definida em `docs/architecture/telegram-adapter.md`.
...
Detalhes estão em `docs/architecture/authorization.md`.
...
- `/cadastro`: inicia (ou reinicia) o cadastro inicial não sensível, com
  ...
  banco antes de aceitar. Detalhes em `docs/architecture/users.md`.
...
usuário — ver `docs/architecture/ai-provider-manager.md`.
