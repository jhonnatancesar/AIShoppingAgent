...
`IntentInterpreter` (`docs/architecture/intent-interpretation.md`), agnóstico de canal;
...
envelope de erro padrão do `docs/development/api-conventions.md`. Atualizações sem mensagem
...
`204` e `500` estão detalhados em `docs/architecture/mission-commands.md`.
