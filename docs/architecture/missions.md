...
funcional permanece definido em `docs/architecture/mission-system.md`.
...
`docs/architecture/mission-transitions.md`, e a agenda na TASK-022, conforme
`docs/architecture/mission-schedules.md`. Critérios pertencem à TASK-020; coleta, API, eventos
