...
TASKs 000 a 014, TASK-016 e TASKs 018 a 023 concluídas: fundação, base técnica, ciclo de vida, modelo de dados, migrações, usuários, produtos, fontes, vendedores, ofertas, auditoria, missões, critérios, seleção de fontes, transições, agenda e adaptador de coleta preparados. A próxima tarefa executável é a TASK-024; a TASK-015 depende da TASK-026.
